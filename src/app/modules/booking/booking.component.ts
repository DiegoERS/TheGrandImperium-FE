...
@Component({
  ...
  imports: [CommonModule,MatPaginatorModule, MatTableModule,ReactiveFormsModule],
...
export class BookingComponent {
  ...
  console.log("www");
      ...
      this.roomService.getAllRoomsByDate(entryDate,departureDate,roomTypeId).subscribe((data: RoomsDTO[]) => {
        this.rooms = data;
