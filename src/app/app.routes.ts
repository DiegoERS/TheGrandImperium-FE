...
import { UpdateAdvertisingsComponent } from './modules/update-advertisings/update-advertisings.component';
...
export const routes: Routes = [{
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'advertising', component: UpdateAdvertisingsComponent, canActivate: [authGuard] },
